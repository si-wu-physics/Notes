...
\section{Characteristic Function}
  ...
  \subsection{Heston Model}
    ...
    \begin{equation}
      \varphi(u_1,u_2)={\rm E}\left[\left.\exp\left(iu_1x_T+iu_2v_T\right)\right|x_t,v_t\right],
    \end{equation}
    where $u_t=\log S_t$. Define $\tau = T-t$, we are seeking a solution in the form of
    \begin{equation}
      \varphi(u_1,u_2) = \exp\left(A(\tau,u_1,u_2)+B(\tau,u_1,u_2)x_t+C(\tau,u_1,u_2)v_t\right).
    \end{equation}
