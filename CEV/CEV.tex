...
\section{SABR}
  ...
  \subsection{Zero correlation}
    ...
    \begin{eqnarray}
      C(T,S,K) &=& (S-K)^+ \nonumber\\
               &+&\frac{\sqrt{SK}}{\pi}\Bigg(\int_0^{\pi}\frac{\sin\theta\sin(\nu\theta)}{b-\cos\theta}
                          \frac{G(\gamma^2T,s(\theta))}{\cosh\left(s(\theta)\right)}d\theta\nonumber\\
               &&\quad\quad\quad\quad\quad + \sin(\nu\pi)\int_0^{+\infty}\frac{e^{-\nu t}\sinh t}{b+\cosh t}
         \frac{G(\gamma^2T,s(t))}{\cosh\left(s(t)\right)}dt\Bigg),
      \label{SABRZC}
    \end{eqnarray}
    where 
    \begin{eqnarray}
      && \sinh\left(s(\theta)\right) =\frac{\gamma}{\sigma_0}\sqrt{2\bar{q}(b-\cos\theta)}, \nonumber\\
      && \sinh\left(s(t)\right) =\frac{\gamma}{\sigma_0}\sqrt{2\bar{q}(b+\cosh t)}.
    \end{eqnarray}
    Here, 
    \begin{equation}
  ...
  \subsection{Non-zero correlation}
    ...
    \begin{equation}
      ...
      L=\frac{\sigma_{{\rm min}}}{\gamma q\sqrt{1-\rho^2}},
    \end{equation}
    and
    \begin{equation}
      I=
    ...
    where
    \begin{equation}
      q=\frac{K^{1-\beta}}{1-\beta},\quad u_0=\frac{\delta q \gamma\rho+\sigma_0-\sigma_{{\rm min}}}{\delta q \gamma\sqrt{1-\rho^2}}.
    \end{equation}
